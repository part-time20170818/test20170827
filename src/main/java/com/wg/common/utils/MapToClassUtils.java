...
public class MapToClassUtils {
     ...
     */
    public static <T> T map2Class(Map<String, Object> map, Class<T> clazz) throws Exception {
     ...
     */
    public static <T> T populateFromMap(Map<String, Object> map, T bean) throws Exception {
        registerDateType();
